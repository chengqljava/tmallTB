    ...
    public void process(Page page) {
        try {
            ...
            Document document = Jsoup
                .parse(page.getHtml().xpath("//ul[@id='J_UlThumb']").toString());
            ...
            for (int i = 0; i < imgElements.size(); i++) {
                for (SizeImage sizeImage : SizeImage.values()) {
                    if (sizeImage.getSize() != null && !"".equals(sizeImage.getSize())) {
                        ...
                        imageDTO
                            .setUrl(imgElements.get(i).attr("data-src").replace("_50x50.jpg", ""));
            ...
            for (int i = 0; i < colorElements.size(); i++) {
                ...
                for (SizeImage sizeImage : SizeImage.values()) {
                    if (sizeImage.getSize() != null && !"".equals(sizeImage.getSize())) {
                        imageDTO = new ImageDTO();
                        imageDTO.setName("颜色" + colorElements.get(i).getElementsByTag("span").text()
                                         + i + sizeImage.getSize());
            ...
            for (int i = 0; i < dtos.size(); i++) {
                ...
                try {
                    ...
                    if (imageDTO.getSize() != null) {
                        download(imageDTO.getUrl() + imageDTO.getSize(),
